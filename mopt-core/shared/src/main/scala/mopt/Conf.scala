...
import mopt.Extractors._
import mopt.generic.Setting
import mopt.generic.Settings
import mopt.internal.CliParser
import mopt.internal.ConfGet
import mopt.internal.ConfPatch
import mopt.internal.HoconPrinter
...
object Conf {
  ...
  def parseFile(
      file: File
  )(implicit parser: MOptParser): Configured[Conf] =
